...
#   - **NEW** Explicit Solvent (TIP3P water box, ions)
#   - **NEW** RESPA multiple time‑step integrator for long MD
#   - **NEW** Automatic hydrogen addition, disulfide detection, protonation
# =============================================================================
...
class RefinementConfig:
    ...
    anneal_cycles: int = 1
    # New options for explicit solvent and RESPA
...
# =============================================================================
# 17. I/O Utilities (shared by training and CLI)
# =============================================================================
