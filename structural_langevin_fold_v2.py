...
class InterfaceDetector(InterfaceDetectorBase):
    ...
    def forward(self, coords: torch.Tensor) -> torch.Tensor:
        ...
        # (O(N^2) memory; crashes for realistic REAL FOLD ONE system
        # sizes). This call is numerically IDENTICAL to the original
        # formula for small N and switches to a memory-safe, still-exact
        # chunked computation once N is large — see
        # structural_interface_utils.py for the derivation and self-test.
